...
export const util = (() => {
    ...
    const guest = () => {
        ...
        div.innerHTML = `<p class="mt-0 mb-1 mx-0 p-0 text-black">${guest.getAttribute('data-message')}</p><h2 class="text-black text-xl font-bold">${escapeHtml(name)}</h2><h3 class="text-black">${escapeHtml(address)}</h3>`;
